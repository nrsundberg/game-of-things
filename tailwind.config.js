  ...
  theme: {
    extend: {
      colors: {
        ...
        copper:    '#a3441e',
        silver:    '#c6c3bc',
        walnut:    { DEFAULT: '#3a2416', lo: '#2a1a10', hi: '#704b2b' },
        wine:      { DEFAULT: '#4d1219', deep: '#2c0a0d', mid: '#6b1a21' },
        navy:      { DEFAULT: '#0f1d33', deep: '#081525', mid: '#17294b' },
        forest:    '#214634',
        /* Game of Things accent tokens */
        kraft:     { DEFAULT: '#e8dcc4', deep: '#d2c39e' },
        cocktail:  '#c8372a',
        mustard:   '#d9a62a',
        teal:      '#2f7a7a',
      },
      ...
      boxShadow: {
        ...
        'pinned':  '0 2px 6px rgba(0,0,0,0.25), 0 8px 20px rgba(0,0,0,0.18)',
        'card-lift': '0 4px 12px rgba(0,0,0,0.3)',
      },
    },
  },
  plugins: [],
